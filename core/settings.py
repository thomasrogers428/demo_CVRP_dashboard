...
#                  env('SERVER', default='127.0.0.1'), 'hobie-dashboard.herokuapp.com']
ALLOWED_HOSTS = ['trogers.pythonanywhere.com, localhost',
                 'localhost:85', '127.0.0.1', env('SERVER', default='127.0.0.1')]
